...
of the classes true extend and even more so of the nuances of the boundarie between this classe and the other classes.

Based on the above we claim that coreset selection should be biased towards the instances further away from the centroid, without completely 
discarding representative instances. 
...
The first center is selected randomly the second is greedily select the point furthest from the first and the remaining centers are determined    
