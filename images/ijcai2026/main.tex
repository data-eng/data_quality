...
Furthermore, at~\cite{khan-kafi-sarker-etall:2021} the authors utilize cosine similarity to assign data to clusters showing its benefits compared with the euclidean one.
...
Additionally, variational autoencoders provide a propabilistic latent representation. 
